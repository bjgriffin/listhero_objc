...
- (void)adjustTableView {
    ...
    rect.size.height = addListButton.frame.origin.y - (_itemTextField.frame.size.height + NAVIGATION_BAR_HEIGHT + [UIApplication sharedApplication].statusBarFrame.size.height);
